                ...
                <div className="login template d-flex justify-content-center align-items-center vh-100 bg-light">
                    <div className='form_container shadow p-5 mb-5  rounded bg-white'>
                        ...
                        <div className='mb-2 p-1'>
                            ...
                            <Form.Control input type='text' placeholder='Username' className='form-control' required />
                        </div>
                        <div className='mb-2 p-1'>
                            <label htmlFor='fullrname' className='mb-2'>Full_rname</label>
                            <Form.Control input type='text' placeholder='Enter Fullrname' className='form-control'required />
                        </div>
                        <div className='mb-2 p-1'>
                            <label htmlFor='regno' className='mb-2'>Register Number</label>
                            <Form.Control input type='text' placeholder='Enter Register Number' className='form-control' required />
                        </div>
                        <div className='mb-2 p-1'>
                            <label htmlFor='password' className='mb-2'>Password</label>
                            <Form.Control input type='password' placeholder='Password' className='form-control' required />
                        </div>
                        <div className='mb-2 p-1'>

                            <label htmlFor='role_id' className='mb-2'>Role ID</label>

                                    <Form.Select required className="roleId"
                                    >
